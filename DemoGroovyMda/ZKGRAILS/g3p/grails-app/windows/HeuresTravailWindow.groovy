...
class HeuresTravailWindow extends Window{
	...
	**/
	def select() {                    
        ...
        //heuresTravail.lock()  //Ne peut etre utilisé que pour le base de donnée qui accepte le veruillage des enregisterments
        rafraichirField()
        activerBoutons(true)
    }
	/**
	* Fonction qui se charge de sauveguarder un nouveau élément de heuresTravail
	**/
    def add() {
	...
	**/
	...
	/**
	* Fonction qui se charge de mettre à jour un élément selectionné de heuresTravail
	**/
    def update() {
		actualiserValeurAssociation()
        heuresTravail.validate()
	...
	/**
	* Fonction qui se charge de supprimer un élément selectinné de heuresTravail
	**/
    def delete() {
