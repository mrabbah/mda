...
class MembreMoaWindow extends Window{
	...
	**/
	def select() {                    
        ...
        //membreMoa.lock()  //Ne peut etre utilisé que pour le base de donnée qui accepte le veruillage des enregisterments
        rafraichirField()
        activerBoutons(true)
    }
	/**
	* Fonction qui se charge de sauveguarder un nouveau élément de membreMoa
	**/
    def add() {
	...
	**/
	...
	/**
	* Fonction qui se charge de mettre à jour un élément selectionné de membreMoa
	**/
    def update() {
		actualiserValeurAssociation()
        membreMoa.validate()
	...
	/**
	* Fonction qui se charge de supprimer un élément selectinné de membreMoa
	**/
    def delete() {
