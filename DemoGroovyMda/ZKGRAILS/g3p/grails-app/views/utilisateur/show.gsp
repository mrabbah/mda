...
<body>
	...
	<div class="nav">
		...
		<span class="menuButton"><g:link class="list" action="list">Utilisateur List</g:link></span>
		<span class="menuButton"><g:link class="create" action="create">New Utilisateur</g:link></span>
	</div>
