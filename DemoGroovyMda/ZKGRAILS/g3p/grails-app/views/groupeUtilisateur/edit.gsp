<head>
	...
	<title>Edit GroupeUtilisateur</title>
</head>
...
<body>
	...
	<div class="nav">
		...
		<span class="menuButton"><g:link class="list" action="list">GroupeUtilisateur List</g:link></span>
		<span class="menuButton"><g:link class="create" action="create">New GroupeUtilisateur</g:link></span>
	</div>

	<div class="body">
		<h1>Edit GroupeUtilisateur</h1>
		...
		<g:form>
			...
			<tbody>
				<tr class="prop">
					<td valign="top" class="name"><label for="authority">GroupeUtilisateur Name:</label></td>
