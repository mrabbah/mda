<head>
	...
	<title>Create DroitUtilisateur</title>
</head>
...
<body>
	...
	<div class="nav">
		...
		<span class="menuButton"><g:link class="list" action="list">DroitUtilisateur List</g:link></span>
	</div>

	<div class="body">
		<h1>Create DroitUtilisateur</h1>
		...
		<g:form action="save">
			<div class="dialog">
				...
				<tbody>
					...
					<tr class="prop">
						<td valign="top" class="name"><label for="configAttribute">GroupeUtilisateur (comma-delimited):</label></td>
